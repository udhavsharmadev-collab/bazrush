      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="mb-12 bg-gradient-to-r from-purple-600 via-purple-700 to-purple-800 rounded-3xl p-8 lg:p-12 shadow-2xl border border-purple-500/50 overflow-hidden relative">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <button onClick={handleSellerClick} className="group relative px-8 py-4 lg:py-5 lg:px-10 bg-white text-purple-700 font-bold text-lg rounded-2xl transition-all duration-300 hover:scale-110 hover:shadow-2xl whitespace-nowrap overflow-hidden cursor-pointer">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/"
                  className="text-gray-700 hover:text-purple-600 transition-colors duration-200 flex items-center space-x-2 group"
                >
              ...
              {/* Delivery Partner link — small but visible */}
              <li>
                <Link
                ...
                >
                  ...
                  <span className="text-[10px] font-black px-1.5 py-0.5 bg-purple-100 text-purple-600 rounded-full"></span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-200 pt-8 mt-12">
          ...
          <div className="flex justify-center items-center space-x-6 mb-6">
            ...
            <a
              href="https://facebook.com/bazrush"
              target="_blank"
              rel="noopener noreferrer"
              className="w-12 h-12 bg-white border-2 border-gray-200 rounded-2xl flex items-center justify-center text-2xl hover:bg-purple-600 hover:text-white hover:border-purple-600 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-110"
              aria-label="Facebook"
          ...
          <p className="text-center text-gray-500 text-sm">
            © {new Date().getFullYear()} Bazrush. Lightning fast, made simple. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
